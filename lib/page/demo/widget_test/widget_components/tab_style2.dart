...
class TabStyleTest2 extends StatefulWidget {
  @override
  _TabStyleTest2State createState() => _TabStyleTest2State();
}

class _TabStyleTest2State extends State<TabStyleTest2>  with SingleTickerProviderStateMixin{
